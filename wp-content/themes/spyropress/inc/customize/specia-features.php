<?php
function spyropress_features_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_panel( 
		...
		array(
			...
			'title'			=> __('Features Section', 'spyropress'),
		) 
	);
	...
	$wp_customize->add_control( 
		'features_title',
		array(
		    'label'   => __('Section Title','spyropress'),
	...
	$wp_customize->add_control( 
		'features_description',
		array(
		    'label'   => __('Section Description','spyropress'),
		    'section' => 'features_header',
	...
	$wp_customize->add_section(
        ...
        array(
        	'priority'      => 3,
            'title' 		=> __('Background','spyropress'),
			'panel'  		=> 'features_panel',
		)
    );
	...
	$wp_customize->add_control(
		'features_background_position' , 
			array(
				'label'          => __( 'Image Position', 'spyropress' ),
				'section'        => 'features_background',
...
add_action( 'customize_register', 'spyropress_features_setting' );

// Feature section selective refresh
function spyropress_home_feature_section_partials( $wp_customize ){
	...
	$wp_customize->selective_refresh->add_partial( 'features_title', array(
		...
		'settings'            => 'features_title',
		'render_callback'  => 'spyropress_home_features_title_render_callback',
	...
	$wp_customize->selective_refresh->add_partial( 'features_description', array(
		...
		'settings'            => 'features_description',
		'render_callback'  => 'spyropress_home_features_description_render_callback',
	
	) );
	}

add_action( 'customize_register', 'spyropress_home_feature_section_partials' );

// features_title
function spyropress_home_features_title_render_callback() {
	return get_theme_mod( 'features_title' );
}
// features_description
function spyropress_home_features_description_render_callback() {
